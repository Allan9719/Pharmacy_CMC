...
| 标签 | 对应内容 |
|------|----------|
| 化学药 | [API / 制剂 / 分析 / 稳定性](CMC_COMPREHENSIVE_GUIDE/small_molecule_drug/api_quality.md)、[化学药发补案例](resources/zh-CN/cases/chemical_drug/) |
| 生物药 | [生物药 CMC 基础](CMC_COMPREHENSIVE_GUIDE/biologic_drug/biologic_basic.md)、[生物药发补案例](resources/zh-CN/cases/biologic_drug/) |
| ATMP | [中国 ATMP CMC 申报实操](CMC_COMPREHENSIVE_GUIDE/biologic_drug/atmp_cmc_zh.md) |
...
| 标签 | 对应内容 |
|------|----------|
| 入门 | [CMC 核心逻辑](CMC_COMPREHENSIVE_GUIDE/basic_theory/ich_framework.md)、[FAQ](FAQ.md) |
| 进阶 | [生物药 vs 小分子](CMC_COMPREHENSIVE_GUIDE/biologic_drug/biologic_basic.md)、[IND 申报要点](CMC_COMPREHENSIVE_GUIDE/biologic_drug/biologic_basic.md) |
| 高阶 | [ATMP 申报实操](CMC_COMPREHENSIVE_GUIDE/biologic_drug/atmp_cmc_zh.md)、[发补案例](resources/zh-CN/cases/) |
